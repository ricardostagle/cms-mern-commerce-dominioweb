...
Client app will start running on [http://localhost:4000](http://localhost:4000).

# Running the client
(Make sure the server is running on port 4000).
1. Register a user using [register](http://localhost:4000/home).
2. Add a new item on the next page. i.e. [add item](http://localhost:4000/addItem).
3. Go to home and you can see all the items that you added.
4. Add an item to the cart. 
5. Go to [cart](http://localhost:4000/cart) to checkout your products.
