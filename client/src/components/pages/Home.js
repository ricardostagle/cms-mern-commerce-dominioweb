            ...
            <div>
                <section id="HOME" onLoad={this.randomNumber.bind(this)} className={"header parallax home-parallax page fun_facts bg"+this.state.random}>
                    ...
                    <><section className="about page" id="ABOUT">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="about_phone wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">
                                        <img className="illustration" src="/imgs/tecnologias.png" alt="" />
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="about_phone wow fadeInRight" data-wow-duration="1s" data-wow-delay=".5s">
                                            <img className="illustration" src="/imgs/valores.png" alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section id="FONDO2" className={"parallax fun_facts bg" + this.state.random}>
                            ...
                            <div className="container">
                                <div className="row">
                                    ...
                                    <div className="col-md-6 wow fadeInRightBig">
                                        <div className="video">
                                            <img className="illustration" src="/imgs/construccion-calidad.png" alt="" />
                                        </div>
                                    </div>
                    ...
                    </section><section id="FEATURES" className="features page">
                            <div className="container">
                                <div className="row">
                        ...
                        </section><section id="FONDO3" className={"parallax fun_facts bg" + this.state.random}>
                            <div className="section_overlay">

                            </div>
                        </section><section className="download page" id="DOWNLOAD">
                        ...
                        </section><div id="google-map" className="wow fadeIn" data-latitude="20.5296883" data-longitude="-103.4587419,17z" data-wow-duration="1000ms" data-wow-delay="400ms" style={{ 'display': 'none' }}></div><section className="contact page" id="CONTACT">
                            <div className="section_overlay">
                        ...
                        </section><section className="subscribe parallax subscribe-parallax" data-stellar-background-ratio="0.6" data-stellar-vertical-offset="20">
