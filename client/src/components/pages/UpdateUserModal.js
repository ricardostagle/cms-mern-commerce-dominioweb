    ...
    render(){
        ...
        return(
            <div className="container">
                <Button color="info" className="btn btn-sm"><NavLink onClick={this.toggle} href="#">Edit</NavLink></Button>
                <Modal
...
export default connect(mapStateToProps,{addUser, clearErrors})(UpdateUserModal);